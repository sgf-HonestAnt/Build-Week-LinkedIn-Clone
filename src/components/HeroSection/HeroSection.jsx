        ...
        <Row className="hero p-0 my-3">
            <Col xs={12} className="p-0 w-100">
                <div className="p-relative">
                    ...
                    <img className="profile-pic" src="https://images.pexels.com/photos/771742/pexels-photo-771742.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" />{/* On the api, this will probably our profile .image */}
                </div>
                <Row>
                    <Col xs={9}>
