...
const ExperienceRow = ({ experiencesData, onUpdate, isMe, id }) => {
  ...
  return (
    <div className="experience-page">
      ...
      <ExperienceModal show={show} onHide={handleClose} action="adding" onUpdate={onUpdate} experienceData={null} id={id} />
    </div>
  )
}
